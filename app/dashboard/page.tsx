...
export default function Dashboard(){
  ...
  return <main className={`dashboard-shell ${theme}`}>
    ...
    <section className="dashboard-main">
      ...
      <DashboardPurchaseCenter enrolledCourses={enrolledCourses}/>
