...
export default function ThoughtToFreedomOverview() {
  ...
  return <main className="ttf-shell"><Header/>
    ...
    {!checking&&!enrolled&&<section className="shell" style={{paddingBottom:"64px",textAlign:"center"}}><h2>Bring TCF Learn to your organization.</h2><p>Organization licenses include Thought to Freedom and Turning Forward for every learner seat.</p><Link className="button" href="/organizations">View Organization Plans</Link></section>}
  </main>;
}
