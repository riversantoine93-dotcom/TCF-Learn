...
export default function ThoughtToFreedomOverview() {
  ...
  return <main className="ttf-shell"><Header/>
    ...
    {!checking&&!enrolled&&<section className="shell" style={{paddingBottom:"64px",textAlign:"center"}}><h2>Ready to enroll?</h2><p>Purchase Thought to Freedom by itself for $97, or choose the $145.50 two-course bundle in the central TCF Learn Course Store.</p><Link className="button" href="/dashboard#purchase-center">View Course Store & Pricing</Link></section>}
  </main>;
}
